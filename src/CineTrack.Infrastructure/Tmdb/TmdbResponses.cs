...
internal class TmdbCreditsResponse
{
...
internal class TmdbPersonCreditsResponse
{
    [JsonPropertyName("cast")]
    public List<TmdbPersonCreditMovie> Cast { get; set; } = [];
}

internal class TmdbPersonCreditMovie
{
    [JsonPropertyName("id")]
    public int Id { get; set; }
...
internal class TmdbDiscoverResponse
{
    [JsonPropertyName("results")]
    public List<TmdbDiscoverMovie> Results { get; set; } = [];

    [JsonPropertyName("total_pages")]
    public int TotalPages { get; set; }
}

internal class TmdbDiscoverMovie
{
    [JsonPropertyName("id")]
    public int Id { get; set; }
